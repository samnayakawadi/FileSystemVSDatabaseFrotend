...
const DELETE = () => {
    ...
    const onLoadQuestionDataHandler = () => {
        ...
        setTimeout(() => {
            ...
            axios.delete(`http://10.244.0.131:19771/questions/delete/single/${questionId}`).then(res => {
    ...
    return (
        <div className="m-3">
            <div className="columns box is-dark is-centered has-text-centered">
                ...
                <div className="column is-7">http://10.244.0.131:19771/questions/delete/single/{questionId}</div>
            </div>
