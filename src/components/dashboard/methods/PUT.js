...
const PUT = () => {
    ...
    const onLoadQuestionDataHandler = () => {
        ...
        setTimeout(() => {
            ...
            axios.get(`http://10.244.0.131:20071/questions/get/single/${questionId}`).then(res => {
    ...
    const onSubmitPostQuestionDataHandler = () => {
        ...
        setTimeout(() => {
            var start = new Date().getTime();
            axios.put(`http://10.244.0.131:20071/questions/put/single`, getAllQuestionsData).then(res => {
    ...
    return (
        <div className="m-3">
            <div className="columns box is-dark is-centered has-text-centered">
                ...
                <div className="column is-7">http://10.244.0.131:20071/questions/put/single</div>
            </div>
